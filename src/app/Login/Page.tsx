  ...
  return (
    <main className="min-h-screen flex flex-col bg-gradient-to-br from-purple-900 to-indigo-900 text-white">
      ...
      <header className="flex justify-between items-center px-6 py-4">
        <div>
          <a href="/" className="text-xl font-bold">SalonClick</a>
        </div>
        <div>
          <input type="text" placeholder="Buscar..." className="rounded px-3 py-1 text-black"/>
        </div>
      </header>
        ...
        <div className="bg-white text-black rounded-xl shadow-lg p-8 w-full max-w-md">
          ...
          <form className="space-y-4">
            <div>
              ...
              <input type="email" className="w-full border rounded-lg px-3 py-2" placeholder="ejemplo@email.com"/>
            </div>
            <div>
            ...
            <button type="submit" className="w-full bg-pink-600 text-white py-2 rounded-full hover:bg-pink-500">
              Ingresar
            </button>
